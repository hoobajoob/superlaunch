...
---[[
			...
			mountain_big2 = display.newImage("mountain_big.png", 132-720, 92) 
			mountain_sma = display.newImage("mountain_small.png", 84, 111)
			mountain_sma2 = display.newImage("mountain_small.png", 84 - 480, 111)
			 
			tree_s = display.newImage("tree_s.png", 129-30, 151) 
			tree_s2 = display.newImage("tree_s.png", 270 + 10,151)
			tree_l = display.newImage("tree_l.png", 145, 131) 
			 
			tree_s3 = display.newImage("tree_s.png", 129-30 - 320, 151) 
			tree_s4 = display.newImage("tree_s.png", 270 + 10 - 320,151)
			tree_l2 = display.newImage("tree_l.png", 145 - 320, 131) 
			 
			tree_s5 = display.newImage("tree_s.png", 129 - 30 - 640, 151) 
			tree_s6 = display.newImage("tree_s.png", 270 + 10 - 640,151)
			tree_l3 = display.newImage("tree_l.png", 145 - 640, 131)
